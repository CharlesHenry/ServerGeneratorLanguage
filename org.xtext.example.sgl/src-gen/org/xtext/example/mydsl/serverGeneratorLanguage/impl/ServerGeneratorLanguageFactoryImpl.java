...
public class ServerGeneratorLanguageFactoryImpl extends EFactoryImpl implements ServerGeneratorLanguageFactory
{
  ...
  public static ServerGeneratorLanguageFactory init()
  {
    try
    {
      ServerGeneratorLanguageFactory theServerGeneratorLanguageFactory = (ServerGeneratorLanguageFactory)EPackage.Registry.INSTANCE.getEFactory(ServerGeneratorLanguagePackage.eNS_URI);
